  ...
  <div class="container">
    ...
    <div class="about-grid reveal">
      <div class="about-text">
        <p>Jake Rodriguez, a Bachelor of Science in Information Technology Graduate based on Cebu, Philippines. I build web applications, mobile apps, and desktop tools — with a focus on clean interfaces and practical functionality.</p>
